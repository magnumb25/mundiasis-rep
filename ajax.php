...
elseif ($_GET['action'] == 'getStudentHavingRatrappage'){
	echo getStudentHavingRatrappage($_GET['id_cours']);
}
elseif ($_GET['action'] == 'getAllInfoAbtoutThisRatra'){
	echo getAllInfoAbtoutThisRatra($_GET['id_cours']);
}
elseif ($_GET['action'] == 'submitNoteRatraStudent'){
	echo addNoteRatraStudentToDatabase($_GET['selectedCourse']);
}
elseif ($_GET['action'] == 'getmoyenneGlob'){
	echo getmoyenneGlob($_GET['id_cours']);
}
